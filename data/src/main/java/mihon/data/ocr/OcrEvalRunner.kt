...
internal object OcrEvalMetrics {
    ...
    fun normalize(text: String): String = text
        .lowercase()
        .replace('ё', 'е')
        // Пробельные символы схлопываются ДО фильтрации: иначе перевод строки
        // и табуляция вырезались бы без замены и «слова\nи» склеивалось в
        // «словаи» — одно лишнее слово в эталоне и неверный CER.
        .replace(Regex("\\s+"), " ")
