...
- Найдено, НЕ исправлено (нужна правка вне модуля data): онлайн-OCR
  ...
  Для пользователя за прокси/VPN OCR и чат пойдут разными путями. Лечится
  доменной абстракцией открытия соединения, регистрируемой из app-модуля.
