...
fun Screen.sourcesTab(): TabContent {
    ...
    var contentType by remember { mutableStateOf(sourcePrefs.contentType.get()) }
    val screenModel = rememberScreenModel(contentType.name) { SourcesScreenModel(contentType = contentType) }
